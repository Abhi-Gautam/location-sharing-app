defmodule LocationSharing.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: LocationSharing.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    LocationSharingWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
